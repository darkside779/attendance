...
const EmployeeManagement: React.FC = () => {
  ...
  const [selectedEmployeeForFace, setSelectedEmployeeForFace] = useState<any>(null);
  ...
  const handleFaceUpload = (employee: any) => {
    setSelectedEmployeeForFace(employee);
    setFaceUploadOpen(true);
  };

  const handleFaceUploadClose = () => {
    setFaceUploadOpen(false);
    setSelectedEmployeeForFace(null);
  };

  const handleFaceUploadSuccess = () => {
    // Refresh employee list to update face data status
    dispatch(fetchEmployees({}));
    handleFaceUploadClose();
  };
    ...
    <Box>
                  ...
                  {filteredEmployees.map((employee) => (
                    <TableRow key={employee.id}>
                      ...
                      <TableCell>
                        ...
                        <IconButton
                          size="small"
                          onClick={() => navigate(`/face-register/${employee.id}`)}
                          color="success"
                          title="Real-Time Face Registration"
                        >
                          <CameraAlt />
                        </IconButton>
                        {user?.role === 'admin' && (
      ...
      {selectedEmployeeForFace && (
        <FaceUpload
          ...
          employeeName={selectedEmployeeForFace.name}
          open={faceUploadOpen}
          onClose={handleFaceUploadClose}
